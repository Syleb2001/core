...
use harness::LtcFastCancelConfig;
...
/// The refund path, on Litecoin: after both sides locked their funds,
/// both manually cancel and refund once the cancel timelock expired.
#[tokio::test]
async fn ltc_given_alice_and_bob_manually_refund_after_funds_locked_both_refund() {
    harness::setup_test(LtcFastCancelConfig, None, None, |mut ctx| async move {
